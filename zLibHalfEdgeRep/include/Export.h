...
namespace MeshHERepLib
{
    extern "C" {
        ...
        HALFEDGEREPLIB_API bool GetEdgeFromHalfEdge(CHalfEdgeRep* object, std::pair<MeshIOLib::index_t, MeshIOLib::index_t>& edge, const MeshIOLib::index_t id);
        ...
        HALFEDGEREPLIB_API bool GetBoundaryEdges(CHalfEdgeRep* object, std::vector<std::pair<MeshIOLib::index_t, MeshIOLib::index_t>>& boundaryEdges);
